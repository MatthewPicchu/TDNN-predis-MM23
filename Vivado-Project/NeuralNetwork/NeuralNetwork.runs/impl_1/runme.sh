...
HD_PWD='C:/Users/mwfmo/Documents/UbuntuShared/NeuralNetwork/NeuralNetwork.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TDNN_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TDNN_TOP.tcl -notrace
